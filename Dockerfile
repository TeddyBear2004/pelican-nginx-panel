...
RUN install-php-extensions bcmath gd intl zip opcache pcntl posix pdo_mysql \
    ...
    && echo "upload_max_filesize=200000000" > /usr/local/etc/php/conf.d/docker-php-upload-limits.ini \
    && echo "post_max_size=200000000" >> /usr/local/etc/php/conf.d/docker-php-upload-limits.ini \
